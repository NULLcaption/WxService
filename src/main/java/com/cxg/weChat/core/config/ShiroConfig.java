...
public class ShiroConfig {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/api/wx/xpp/*","anon");
        filterChainDefinitionMap.put("/api/userInfo/xpp/*","anon");
        filterChainDefinitionMap.put("/api/wx/meco/*","anon");
        filterChainDefinitionMap.put("/api/userInfo/meco/*","anon");
        filterChainDefinitionMap.put("/api/wx/lfy/*","anon");
        filterChainDefinitionMap.put("/api/userInfo/lfy/*","anon");
        filterChainDefinitionMap.put("/api/userInfo/admin/*","anon");
        filterChainDefinitionMap.put("/api/wx/admin/*","anon");

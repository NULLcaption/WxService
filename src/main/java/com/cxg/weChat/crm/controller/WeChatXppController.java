...
@Controller
@RequestMapping("/api/wx/xpp")
public class WeChatXppController {
    private static Logger logger = LoggerFactory.getLogger(WeChatXppController.class);

    private String appid = "wxd570425c5356eaa9";
    private String appSercret = "aae815349cd1969157d473b02bf79a7d";

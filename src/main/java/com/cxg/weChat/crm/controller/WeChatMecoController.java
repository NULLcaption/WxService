...
@Controller
@RequestMapping("/api/wx/meco")
public class WeChatMecoController {
    private static Logger logger = LoggerFactory.getLogger(WeChatMecoController.class);

    private String appid = "wx3ef893bc1a84ce86";
    private String appSercret = "9eb0de8457e901eb50b7cc19a2d1a20a";

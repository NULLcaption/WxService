...
@Controller
@RequestMapping("/api/wx/lfy")
public class WeChatLfyController {
    private static Logger logger = LoggerFactory.getLogger(WeChatLfyController.class);

    private String appid = "wx1fd2c4c28ce04e0c";
    private String appSercret = "7e9b8c335af3670137548ab1821a5337";
